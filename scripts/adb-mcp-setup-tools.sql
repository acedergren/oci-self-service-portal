-- =============================================================================
-- Oracle Autonomous AI Database MCP Server — Tool Setup
-- =============================================================================
-- Run this script in Database Actions SQL Worksheet (ADMIN user) for each ADB:
--
--   charleston-adb-26ai:  https://QS0PZ87QP3GFIHY-CHARLSTN26.adb.eu-frankfurt-1.oraclecloudapps.com/ords/sql-developer
--   Langflow Database:    https://QS0PZ87QP3GFIHY-LANGFLOWDB.adb.eu-frankfurt-1.oraclecloudapps.com/ords/sql-developer
--   Running Days Prod v2: https://QS0PZ87QP3GFIHY-RUNNINGDAYS2.adb.eu-frankfurt-1.oraclecloudapps.com/ords/sql-developer
--
-- Tools created:
--   1. LIST_SCHEMAS       — List non-Oracle-maintained schemas
--   2. LIST_OBJECTS        — List tables, views, functions in a schema
--   3. GET_OBJECT_DETAILS  — Get columns, indexes, constraints for an object
--   4. EXECUTE_SQL         — Run read-only SELECT queries with pagination
-- =============================================================================
...
-- ---------------------------------------------------------------------------
SELECT tool_name, status FROM USER_CLOUD_AI_AGENT_TOOLS;
