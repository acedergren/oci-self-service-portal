 ...
 */
export async function fetchAzureVMPricing(region: string = 'westeurope'): Promise<AzurePriceItem[]> {
...
export function calculateOCIComputeCost(
  ...
  const pricing = usePreemptible && instance.preemptible 
