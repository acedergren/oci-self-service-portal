...
<div class="approval-overlay">
  <div class="approval-dialog" role="alertdialog" aria-modal="true" aria-labelledby="approval-title" aria-describedby="approval-desc">
    <!-- Header -->
    ...
    <div class="approval-content">
      ...
      {#if approval.warningMessage}
        <div class="approval-warning">
          ...
          <div>
            <strong>Warning:</strong> {approval.warningMessage}
