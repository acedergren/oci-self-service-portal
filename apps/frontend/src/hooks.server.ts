...
import { initPool, closePool } from '@portal/shared/server/oracle/connection.js';
import { runMigrations } from '@portal/shared/server/oracle/migrations.js';
import { auth } from '@portal/shared/server/auth/config.js';
import { getPermissionsForRole, type Permission } from '@portal/shared/server/auth/rbac.js';
import { getOrgRole } from '@portal/shared/server/auth/tenancy.js';
import { checkRateLimit, RATE_LIMIT_CONFIG } from '@portal/shared/server/rate-limiter.js';
import { generateRequestId, REQUEST_ID_HEADER } from '@portal/shared/server/tracing.js';
import { RateLimitError, AuthError, PortalError, errorResponse } from '@portal/shared/server/errors.js';
import { httpRequestDuration } from '@portal/shared/server/metrics.js';
import { initSentry, captureError, closeSentry } from '@portal/shared/server/sentry.js';
import { validateApiKey } from '@portal/shared/server/auth/api-keys.js';
